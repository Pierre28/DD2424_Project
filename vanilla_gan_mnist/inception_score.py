#Code dervived from https://github.com/openai/improved-gan/blob/master/inception_score/model.py
'''
...
def get_inception_score(images, splits=10):
    ...
    print('Inception Score for', preds.shape[0], 'samples in', splits,'splits')
